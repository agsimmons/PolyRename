...
def test_prefix():
    ...
    assert transformation.resolve() == [Path('/home/test/HelloWorldexample.py'), Path('HelloWorldfile_without_extension'), Path('HelloWorldrelative.jpg'), Path('relative/path/HelloWorldextreme_extreme04.tar.gz')]
...
def test_suffix():
    ...
    assert transformation.resolve() == [Path('/home/test/exampleHelloWorld.py'), Path('file_without_extensionHelloWorld'), Path('relativeHelloWorld.jpg'), Path('relative/path/extreme_extreme04.tarHelloWorld.gz')]
...
def test_date_time():
    ...
    assert transformation.resolve() == [Path('/home/test/example (2012-01-03).py'), Path('file_without_extension (2012-01-03)'), Path('relative (2012-01-03).jpg'), Path('relative/path/extreme_extreme04.tar (2012-01-03).gz')]
...
def test_insert():
    ...
    assert transformation.resolve() == [Path('/home/test/examplehello.py'), Path('file_wihellothout_extension'), Path('relativhelloe.jpg'), Path('relative/path/extremehello_extreme04.tar.gz')]
...
def test_remove_range():
    ...
    assert transformation.resolve() == [Path('/home/test/ample.py'), Path('le_without_extension'), Path('lative.jpg'), Path('relative/path/treme_extreme04.tar.gz')]

    transformation = remove_range.RemoveRangeTransformation(TEST_SEQUENCE_01, 0, 100)
    assert transformation.resolve() == [Path('/home/test/.py'), Path(''), Path('.jpg'), Path('relative/path/.gz')]
...
def test_replace_extension():
    ...
    assert transformation.resolve() == [Path('/home/test/example.txt'), Path('file_without_extension.txt'), Path('relative.txt'), Path('relative/path/extreme_extreme04.tar.txt')]
